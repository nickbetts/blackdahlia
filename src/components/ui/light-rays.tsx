...
const Ray = ({ left, rotate, width, swing, delay, duration, intensity }: LightRay) => (
  <motion.div
    className="pointer-events-none absolute top-[-12%] h-(--light-rays-length) origin-top -translate-x-1/2 rounded-full bg-linear-to-b from-[color-mix(in_srgb,var(--light-rays-color)_70%,transparent)] to-transparent opacity-0 mix-blend-screen blur-(--light-rays-blur)"
    style={{
      left: `${left}%`,
      width: `${width}px`,
    } as CSSProperties}
